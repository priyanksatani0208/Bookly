...
public class DeleteContactServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean deleted = contactdao.deleteContact(contId);

            if (deleted) {
                response.sendRedirect("view_contact.jsp?msg=ds"); // Success message
            } else {
                response.sendRedirect("view_contact.jsp?msg=de"); // Error message
            }
