...
<%
    ...
    if (bookIdParam != null && !bookIdParam.isEmpty()) {
        ...
        try {
            ...
            response.sendRedirect("404.jsp"); // Redirect to an error page if something goes wrong
        }
    } else {
        response.sendRedirect("404.jsp"); // Redirect to an error page if the bookId is missing
    }
%>
<!DOCTYPE html>
<html lang="zxx">
