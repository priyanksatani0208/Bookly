                            ...
                            <div class="col-md-9">
                                ...
                                <div class="navbar-collapse hidden-sm hidden-xs">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle disabled" href="news-events-list-view.jsp">News &amp; Events</a>
                                            <ul class="dropdown-menu">
                                                <li><a href="news-events-list-view.jsp">News &amp; Events List View</a></li>
                                                <li><a href="news-events-detail.jsp">News &amp; Events Detail</a></li>
                                            </ul>
                                        </li>
                                        <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle disabled" href="blog.jsp">Blog</a>
                                            <ul class="dropdown-menu">
                                                <li><a href="blog.jsp">Blog Grid View</a></li>
